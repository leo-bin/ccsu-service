...
public interface TopicMapper {
    ...
    List<Map> findTopic(@Param("openId") String openId, @Param("good") Boolean good, @Param("top") Boolean top,
    ...
    int countTopic(@Param("openId") String openId, @Param("good") Boolean good,
                   @Param("top") Boolean top, @Param("commentCount") Integer commentCount,
    ...
    List<Map> findTopicsByTagId(
            @Param("tagId") Integer tagId, @Param("pageNo") Integer pageNo,
            @Param("pageSize") Integer pageSize, @Param("orderBy") String orderBy);
